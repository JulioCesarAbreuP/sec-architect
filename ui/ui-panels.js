export function getPanelRefs() {
  return {
    ...
    tiStatus: document.getElementById("tiStatus"),
    tiLastUpdated: document.getElementById("tiLastUpdated"),
    tiTopTechniqueCount: document.getElementById("tiTopTechniqueCount"),
    tiTrendDirection: document.getElementById("tiTrendDirection"),
    tiScoreInfluence: document.getElementById("tiScoreInfluence"),
    tiTopTechniques: document.getElementById("tiTopTechniques"),
    tiConfidenceTrend: document.getElementById("tiConfidenceTrend"),
    tiTimeline: document.getElementById("tiTimeline"),
